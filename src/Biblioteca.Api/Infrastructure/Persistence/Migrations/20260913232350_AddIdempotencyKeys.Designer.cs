...
namespace Biblioteca.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913232350_AddIdempotencyKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biblioteca.Api.Infrastructure.Idempotency.IdempotencyKeyEntry", b =>
                {
                    ...
                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_idem_expires_at");

                    b.ToTable("idempotency_keys", null, t =>
                        {
                            t.HasCheckConstraint("ck_idem_completed", "status <> 'Completed' OR (response_status IS NOT NULL AND response_body IS NOT NULL)");
